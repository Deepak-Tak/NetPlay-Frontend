...
const Details = ({ data }) => {
    ...
    return <div className="flex flex-col">
        <p className="text-xl max-[500px]:text-base break-all  font-bold">{snippet.title}</p>
        <div className="min-h-[54.4px] flex max-[380px]:flex-wrap  justify-between">
            ...
            <div className="flex flex-wrap max-[380px]:justify-start justify-end pt-3">
        ...
        <div className="my-4 ">
            <div ref={scrollref} onClick={() => setDescriptionActive(1)} className={`bg-[#0000000D] ${descriptionActive ? " " : " hover:cursor-pointer"}  p-2 rounded-md mt-3 leading-10`}>
                ...
                <p className="inline break-all"> {descriptionActive ? snippet.description : snippet.description.slice(0, 100) + " "}</p>
