...
const Mic = ({ setSearchQuery }) => {
    ...
    return <div onClick={(e) => e.stopPropagation()}> <div onClick={() => setActive(!active)} className="bg-slate-200 h-10 flex w-10 rounded-full ml-4 cursor-pointer hover:bg-slate-300">
