...
const Sidebar = () => {
  ...
  return (
    <div
      className={`flex  box-border py-5  border-t-[64px] h-screen ml-1 align-middle
      flex-col z-[30] shrink-0 overflow-y-scroll relative  w-auto bg-white scrollbar-none
      pr-[11px]
      hover:pr-0
        ${toogle ? " hover:scrollbar-thin" : "hover:scrollbar-thin max-[500px]:hidden "}
        max-[500px]:fixed
        max-[500px]:h-full
        max-[500px]:w-screen`}
    >
        ...
        <div className="border-b-2 pb-2 ">
          <div onClick={() => {
            if (window.screen.width < 950)
              dispatch(setToogle())
            navigate("/")
          }} className="flex p-3 cursor-pointer  justify-start min-[500]:hover:bg-[#f0f0f0] rounded-md">
          ...
          <div className="flex p-3 cursor-pointer  max-[500px]:shrink-0 min-[500]:hover:bg-[#f0f0f0] justify-start rounded-md">
