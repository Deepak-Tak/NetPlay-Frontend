  ...
  return (
    <div className="p-4 hover:p-2 basis-[340px] min-w-0 flex-shrink cursor-pointer">
      ...
      <div className="p-2">
        ...
        <div className="w-1/2 h-4 bg-slate-200 bg-cover bg-no-repeat animate-pulse rounded-md mb-1"></div>
        <div className="flex">
          <div className="w-1/4 h-4 bg-slate-200 bg-cover bg-no-repeat animate-pulse rounded-md mr-2"></div>
          <div className="w-1/4 h-4 bg-slate-200 bg-cover bg-no-repeat animate-pulse rounded-md"></div>
        </div>
      </div>
    </div>
  );
